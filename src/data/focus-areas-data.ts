...
export const focusAreas: FocusArea[] = [
  {
    ...
    title: "Support for Rare Disease Patients",
    description:
    ...
    keyPoints: [
      ...
      "Supporting treatment through transparent and responsible fundraising initiatives",
      "Raising awareness about rare diseases and the challenges faced by patients and caregivers",
      "Encouraging community support for families navigating rare disease treatment journeys",
    ],
  },
  {
    id: "womens-health",
    title: "Women's Health & Menstrual Awareness",
    description:
    ...
    keyPoints: [
      ...
      "Distributing sanitary products to girls in underserved communities",
      "Educating communities to reduce stigma and misconceptions about menstruation",
      "Promoting dignity, confidence, and improved health awareness among young women",
    ],
  },
  {
    ...
    keyPoints: [
      ...
      "Educating communities about nutrition and healthy lifestyles",
      "Raising awareness about common diseases and early symptoms",
      "Encouraging community participation in maintaining healthier environments",
    ],
  },
  {
    id: "school-hygiene-education",
    title: "School Hygiene Education",
    description:
    ...
    keyPoints: [
      ...
      "Promoting menstrual health awareness among adolescent students",
      "Encouraging healthy habits that support long-term well-being",
      "Creating interactive learning environments that make health education accessible and engaging",
    ],
  },
];
